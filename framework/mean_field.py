...
for step in tqdm(range(num_steps)):
    ...
    for i in permutation:
        ...
        if i < no_pellet_num_cycle:
            # pickup algorithm
            pos = random_pos
            material = pickup_policy(pos, world, x_rand=x_random[i])
        ...
        # pellet agents
            ...
            pos = random_pos
            new_pos = drop_policy(pos, world, x_rand=x_random[i])
...
if collect_data:
    ...
    params = ['num_steps={}'.format(num_steps),
              ...
              'runtime={}s'.format(int(end_time - start_time))]+['']*(num_steps-3)
    data_dict = {
        'params':params,
        'steps':steps,
    ...
    df.to_pickle('./exports/dataframes/meanfield_data.pkl')
